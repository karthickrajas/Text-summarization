...
input_texts = list(data.Text)
target_texts = list(data.Summary)
#Preparing the data for teacher forcing
target_texts_inputs = ['<sos> '+x for x in target_texts]
...
while True:
  ...
  print('-')
  print('Input Description:', input_texts[i])
  print('Predicted Summary:', translation)
